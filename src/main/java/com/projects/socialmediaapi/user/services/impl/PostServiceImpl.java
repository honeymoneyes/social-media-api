...
import static com.projects.socialmediaapi.user.services.impl.ImageServiceImpl.getFileName;
...
public class PostServiceImpl implements PostService {
    ...
    public UploadPostResponse createPost(PostRequest request) {
        ...
        Image image = imageServiceImpl.getImage(request, person);
    ...
    @Transactional
    public UpdatePostResponse updatePost(PostRequest request, Long id) {
        Person person = getAuthenticatePerson();
    ...
    private void imageUpdate(PostRequest request, Post post) {
    ...
    private static void setAllPropertiesImage(PostRequest request, Image image){
        try {
