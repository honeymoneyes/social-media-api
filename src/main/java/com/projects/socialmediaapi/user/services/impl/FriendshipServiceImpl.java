...
public class FriendshipServiceImpl implements FriendshipService {
    ...
    public FriendShipResponse follow(Long receiverId) {
        ...
        Result result = userInteractionServiceImpl.checkUsersAreNotSameUserAndGetThem(receiverId);
    ...
    public FriendShipResponse acceptRequest(Long subscriberId) {
        ...
        Result result = userInteractionServiceImpl.checkUsersAreNotSameUserAndGetThem(subscriberId);
    ...
    public FriendShipResponse rejectRequest(Long senderId) {
        ...
        Result result = userInteractionServiceImpl.checkUsersAreNotSameUserAndGetThem(senderId);
    ...
    private static Set<PersonResponse> getResponses(Set<Person> friends) {
        return friends.stream()
                .map(FriendshipServiceImpl::getPersonResponse)
                .collect(toSet());
    }
